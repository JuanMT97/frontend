<template>
  <div>
    ...
    <div class="container">
        ...
        <form>
          <div class="card">
            <h4 class="card-header text-center">Bloque 0. Datos de los encuestadores y participantes</h4>
            <div class="card-body">
              ...
              <div class="form-row">                             
                ...
                <div class="form-group col-md-4">
                <label for="fechaNacimiento">Fecha de nacimiento</label>
                <input type="date" v-model="encuesta.fechaNacimientoBebe" class="form-control" >
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="row">
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" v-model="encuesta.viaNacimiento" id="viaNacimiento1" value="Parto Vaginal">
                      <label class="form-check-label" for="viaNacimiento">
                        Parto vaginal
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" v-model="encuesta.viaNacimiento" id="viaNacimiento2" value="Cesarea">
                      <label class="form-check-label" for="viaNacimiento">
                        Cesarea
                      </label>
                    </div>
              ...
              <div class="form-row">                             
                ...
                <input type="text" v-model="encuesta.lugarNacimiento" class="form-control" >
                </div>
                <div class="form-group col-md-6">
                <label for="nombreBebe">Nombre niño/a</label>
                <input type="text" v-model="encuesta.nombreBebe" class="form-control">
                </div>
              </div>
              <div class="form-group">
          ...
          <div class="card">
            <h4 class="card-header text-center">Bloque 5. Antropometría neonato</h4>
            <div class="card-body">
              <h6 class="card-title">Ahora vamos a hacer algunas mediciones para conocer el peso, largo y otros datos de la composición corporal del bebé.</h6>
              <hr/>
              <div class="form-row">                             
                <div class="form-group col-md-4">
              ...
              <div class="form-row">                             
                <div class="form-group col-md-6">
                <label for="perimetroCefalico">5.3 Perímetro cefálico (cm)</label>
                <input type="number" v-model="encuesta.perimetroCefalico" class="form-control" >
                </div>
                <div class="form-group col-md-6">
                <label for="cincunsferenciaBrazo">5.4 Cincunsferencia del brazo (cm)</label>
                <input type="number" v-model="encuesta.circunsferenciaBrazo" class="form-control" >
                <small> La medida 5.4 tomar del lado derecho del cuerpo. </small>
                </div>
              </div>
              ...
              <div class="form-row">                             
                ...
                <input type="text" v-model="encuesta.NombreApellidoMadre" class="form-control" >
                </div>
                <div class="form-group col-md-6">
                <label for="DNIMadre">DNI</label>
                <input type="number" v-model="encuesta.dniMadre" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <label for="observacionesBloque5">Observaciones</label>
                <input type="text" v-model="encuesta.observacionesBloque5" class="form-control" >
              </div>
              <div class="btn-group" >
...
class Encuesta {
  ...
  nombreApellido, dni,fechaNacimiento, domicilioBarrio, telefono, fechaNacimientoBebe, viaNacimiento, lugarNacimiento, nombreBebe, observacionesBloque0,
  pesoKG, ropaAlPesar, talla, perimetroCefalico, circunsferenciaBrazo, NombreApellidoMadre, dniMadre, observacionesBloque5) {
