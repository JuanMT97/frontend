          ...
          <form>
            <div class="card">
              <h4 class="card-header text-center">
                Bloque 0. Datos de los encuestadores y las embarazadas
              </h4>
              <div class="card-body">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    <label for="fechaMenstruacion"
                      >Fecha de última menstruacion</label
                    >
                    <input
                      type="date"
                  ...
                  <div class="form-group col-md-4">
                    <label for="semanasGestacionEmbarazada"
                      >Semanas de gestación</label
                    >
                    <input
                      type="number"
            ...
            <div class="card">
              <h4 class="card-header text-center">
                Bloque 1. Antecedentes de salud
              </h4>
              <div class="card-body">
                <h6 class="card-title">
                  Ahora le voy a preguntar sobre algunos datos sobre su salud,
                  las enfermedades que ha tenido o tiene y algunos hábitos.
                </h6>
                <hr />
                <form>
                  <label
                  ...
                  <div class="form-row">
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.enfermedadRenal"
                          id="enfermedadRenal1"
                          value="Si"
                        />
                    ...
                    <div class="col-7">
                      <legend class="col-form-label">
                        Colesterol - Trigliceridos altos
                      </legend>
                    </div>
                    <div class="col">
                      <div class="form-check">
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.asmaEPOC"
                          id="asma1"
                          value="Si"
                        />
                        <label class="form-check-label" for="asma"> Si </label>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-check">
                        <input
                          ...
                          value="No"
                        />
                        <label class="form-check-label" for="asma"> No </label>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-check">
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.covid19"
                          id="covid1"
                          value="Si"
                        />
                        <label class="form-check-label" for="covid"> Si </label>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-check">
                        <input
                          ...
                          value="No"
                        />
                        <label class="form-check-label" for="covid"> No </label>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-check">
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.enfermedadCronica"
                          id="enfermedadCronica1"
                          value="Si"
                        />
                  ...
                  <div class="col">
                    <div class="form-check">
                      <input
                        class="form-check-input"
                        type="radio"
                        v-model="encuesta.consumeMedicamento"
                        id="consumeMedicamento1"
                        value="Si"
                      />
                ...
                <div class="form-row">
                  <div class="col-7">
                    <legend class="col-form-label">
                      1.3 Antes o durante el embarazo, ¿consumió algún complejo
                      vitaminico o suplemento?
                    </legend>
                    <small
                      >Aquí se puede ejemplificar preguntando por suplementación
                      de hierro, ácido folico, vitamina D.</small
                    >
                  </div>
                  <div class="col">
                    <div class="form-check">
                      <input
                        ...
                        id="consumeComplejoVitaminicoSuplemento1"
                        value="Si"
                      />
                      <label
                        class="form-check-label"
                        for="consumeComplejoVitaminicoSuplemento"
                      >
                        Si
                      </label>
                    </div>
                  ...
                  <div class="col">
                    <div class="form-check">
                      <input
                        ...
                        type="radio"
                        v-model="encuesta.consumeComplejoVitaminicoSuplemento"
                        id="consumeComplejoVitaminicoSuplemento2"
                        value="No"
                      />
                      <label
                        class="form-check-label"
                  ...
                  <div class="col">
                    <div class="form-check">
                      <input
                        ...
                        type="radio"
                        v-model="encuesta.consumeComplejoVitaminicoSuplemento"
                        id="consumeComplejoVitaminicoSuplemento3"
                        value="NS/NC"
                      />
                      <label
                        class="form-check-label"
                ...
                <div class="form-group">
                  ...
                  <label for="cualConsumeComplejoVitaminicoSuplemento"
                    >¿Cúal?</label
                  >
                  <input
                    type="text"
                ...
                <div class="form-row">
                  <div class="col-7">
                    <legend class="col-form-label">
                      1.5 ¿Fumaba antes de estar embarazada?
                    </legend>
                  </div>
                  <div class="col">
                    <div class="form-check">
                ...
                <div class="form-row">
                  <div class="col-7">
                    <legend class="col-form-label">
                      1.6 ¿Actualmente consume bebidas alcoholicas?
                    </legend>
                  </div>
                  <div class="col">
                    <div class="form-check">
                      <input
                        class="form-check-input"
                        type="radio"
                        v-model="encuesta.alcoholActual"
                        id="alcoholActual1"
                        value="No, nunca"
                      />
                  ...
                  <div class="col">
                    <div class="form-check">
                      <input
                        class="form-check-input"
                        type="radio"
                        v-model="encuesta.embarazoAntes"
                        id="embarazoAntes1"
                        value="Si"
                      />
                  ...
                  <div class="col">
                    <div class="form-check">
                      <input
                        class="form-check-input"
                        type="radio"
                        v-model="encuesta.hijos"
                        id="hijos1"
                        value="Si"
                      />
                      <label class="form-check-label" for="hijos"> Si </label>
                    </div>
                  </div>
                  <div class="col">
                    <div class="form-check">
                      <input
                        ...
                        value="No"
                      />
                      <label class="form-check-label" for="hijos"> No </label>
                    </div>
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="card">
              <h4 class="card-header text-center">
                Bloque 2. Datos socio-ambientales
              </h4>
              <div class="card-body">
                <h6 class="card-title">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="personasVivienda"
                      >2.3 ¿Cuántas personas viven normalmente en su
                      vivienda?</label
                    >
                    <input
                      type="number"
                  ...
                  <div class="form-group col-md-6">
                    <label for="habitacionesVivienda"
                      >2.4 ¿Cuántas habitaciones tiene su vivienda?</label
                    >
                    <input
                      type="number"
                  ...
                  <div class="col">
                    <div class="form-check">
                      <input
                        class="form-check-input"
                        type="radio"
                        v-model="encuesta.desagueCloaca"
                        id="desagueCloaca1"
                        value="Si"
                      />
                ...
                <div class="form-row">
                  <div class="col-7">
                    <legend class="col-form-label">
                      2.6 ¿Tiene conexión a la red de agua potable dentro de su
                      vivienda?
                    </legend>
                  </div>
                  <div class="col">
                ...
                <div class="form-row">
                  <div class="col-7">
                    <legend class="col-form-label">
                      2.8 ¿Utiliza gas natural para cocinar?
                    </legend>
                  </div>
                  <div class="col">
                    <div class="form-check">
                ...
                <div class="form-group">
                  <label for="nivelEducativo"
                    >2.9 ¿Cuál es el nivel educativo máximo que ha
                    alcanzado?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.nivelEducativo"
                    id="nivelEducativoSelect"
                  >
                ...
                <div class="form-group">
                  <label for="empleo"
                    >2.10 Respecto a su empleo, actualmente se encuentra:</label
                  >
                  <select
                    class="form-control"
                  ...
                  <div class="col">
                    <div class="form-check">
                      <input
                        class="form-check-input"
                        type="radio"
                        v-model="encuesta.asistenciaEstado"
                        id="asistenciaEstado1"
                        value="Si"
                      />
                ...
                <form>
                  ...
                  <div class="form-row">
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.recibioBolson"
                          id="recibioBolson1"
                          value="Si"
                        />
                    ...
                    <div class="col-7">
                      <legend class="col-form-label">
                        ¿Tickets o bonos para la compra de alimentos?
                      </legend>
                    </div>
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.recibioTickets"
                          id="recibioTickets1"
                          value="Si"
                        />
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.recibioTarjeta"
                          id="recibioTarjeta1"
                          value="Si"
                        />
                    ...
                    <div class="col-7">
                      <legend class="col-form-label">
                        ¿Otra forma de asistencia alimentaria?
                      </legend>
                    </div>
                    <div class="col">
                      <div class="form-check">
                ...
                <hr />
                <div class="form-group">
                  <label for="ingresoIndividual"
                    >2.13 ¿Podría indicar cuál de estos tramos se ubica su
                ...
                <hr />
                <div class="form-group">
                  <label for="ingresoTotal"
                    >2.14 ¿Podría indicar en cuál de estos tramos se ubica el
                    ingreso total mensual del hogar en pesos?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.ingresoTotal"
                    id="ingresoTotalSelect"
                  >
            ...
            <div class="card">
              <h4 class="card-header text-center">
                Bloque 3. Antropometría embarazada
              </h4>
              <div class="card-body">
                <h6 class="card-title">
                  Ahora vamos a hacer algunas mediciones para conocer su peso,
                  su altura y otros datos de su composición corporal.
                </h6>
                <hr />
                <div class="form-row">
                  <div class="form-group col-md-4">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="perimetroBraquial"
                      >3.4 Perímetro braquial (cm)</label
                    >
                    <input
                      type="number"
                    ...
                    />
                    <small>
                      Las mediciones entre 3.4 y 3.8 tomarlas del lado derecho
                      del cuerpo.
                    </small>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="pliegueTricipal"
                      >3.5 Pliegue tricipal (cm)</label
                    >
                    <input
                      type="number"
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="pliegueSubescapular"
                      >3.7 Pliegue subescapular (cm)</label
                    >
                    <input
                      type="number"
                  ...
                  <div class="form-group col-md-6">
                    <label for="pliegueSuprailiaco"
                      >3.8 Pliegue suprailíaco (cm)</label
                    >
                    <input
                      type="number"
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <small
                  >Durante los últimos doce meses, ha habido algún momento en
                  que:</small
                >
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          ...
                          id="preocupadoSuficienteAlimentos1"
                          value="Si"
                        />
                        <label
                          class="form-check-label"
                          for="preocupadoSuficienteAlimentos"
                        >
                          Si
                        </label>
                      </div>
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          ...
                          type="radio"
                          v-model="encuesta.preocupadoSuficienteAlimentos"
                          id="preocupadoSuficienteAlimentos2"
                          value="No"
                        />
                        <label
                          class="form-check-label"
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          ...
                          type="radio"
                          v-model="encuesta.preocupadoSuficienteAlimentos"
                          id="preocupadoSuficienteAlimentos3"
                          value="NS/NC"
                        />
                        <label
                          class="form-check-label"
                  ...
                  <div class="form-row">
                    <div class="col-7">
                      <legend class="col-form-label">
                        ...
                        alimentos saludables y nutritivos por falta de dinero u
                        otros recursos?
                      </legend>
                    </div>
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.podidoAlimentos"
                          id="podidoAlimentos1"
                          value="Si"
                        />
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.comidoPocaVariedad"
                          id="comidoPocaVariedad1"
                          value="Si"
                        />
                        <label
                          class="form-check-label"
                          for="comidoPocaVariedad"
                        >
                          Si
                        </label>
                      </div>
                ...
                <form>
                  <div class="form-row">
                    <div class="col-7">
                      <legend class="col-form-label">
                        4.4 ¿Hubo alguna vez en que usted haya tenido que dejar
                        de desayunar, almorzar o cenar porque no había
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          ...
                          id="dejarDesayunoAlmuerzoCena1"
                          value="Si"
                        />
                        <label
                          class="form-check-label"
                          for="dejarDesayunoAlmuerzoCena"
                        >
                          Si
                        </label>
                      </div>
                ...
                <form>
                  <div class="form-row">
                    <div class="col-7">
                      <legend class="col-form-label">
                        4.6 ¿Hubo alguna vez en que su hogar se haya quedado sin
                        alimentos por falta de dinero u otros recursos?
                      </legend>
                    </div>
                    <div class="col">
                      <div class="form-check">
                    ...
                    <div class="col">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          v-model="encuesta.sentidoHambre"
                          id="sentidoHambre1"
                          value="Si"
                        />
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <hr />
                <p>
                  Ahora necesito que me cuente qué comió durante todo el día de
                  ayer, desde la mañana hasta la noche.
                </p>
                <table class="table">
                  <thead>
                    <tr>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <small
                  >Durante los últimos 7 dias, cuántas veces realizó las
                  siguientes comidas:</small
                >
                <div class="form-group"></div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                ...
                <div class="form-group">
                  <label for="frecuenciaConsumo"
                    >4.14 Durante los últimos 7 días, ¿con que frecuencia
                  ...
                  <small
                    >Solo en caso de responder afirmativamente la pregunta 4.14,
                    pasar a la 4.15.</small
                  >
                </div>
                <fieldset class="form-group">
                  <div class="form-group">
                    <label for="alimentoBebidas"
                      >4.15 Durante los últimos 7 días ¿Qué alimentos/bebidas
                      consumió en esas ocasiones fuera de las comidas
                      principales?</label
                    >
                    <div class="col-sm-10">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="opcion1">
                          Golosinas, dulces, galletitas dulces, amasados de
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="opcion7">
                          Bebidas azucaradas (jugos, gaseosas, infusiones con
                          azúcar, etc)
                        </label>
                      </div>
                      <div class="form-check">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <small
                  ...
                  ¿cuántas veces al mes consumió...</small
                >
                <div class="form-group"></div>
                <div class="form-group">
                  <label for="consumioLeche"
                    >4.16. ... leche, yogur o quesos?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioLeche"
                    id="consumioLecheSelect"
                  >
                ...
                <div class="form-group">
                  <label for="consumioFrutasFrescas"
                    >4.17. ... frutas frescas (solas o en preparaciones)?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioFrutasFrescas"
                    id="consumioFrutasFrescasSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioVerduras"
                    >4.18. ...verduras (solas o en preparaciones) sin contar
                    papa y batata?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioVerduras"
                    id="consumioVerdurasSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioPapa"
                    >4.19. ... papa, batata, cereales refinados como arroz
                    blanco, pastas, tartas, empanadas o pan blanco?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioPapa"
                    id="consumioPapaSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioCereales"
                    >4.20. ...cereales integrales, legumbres (por ejemplo
                ...
                <div class="form-group">
                  <label for="consumioEmbutidos"
                    >4.21. ... embutidos y fiambres (jamón, salame, chorizo,
                    salchicha, etc)?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioEmbutidos"
                    id="consumioEmbutidosSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group"></div>
                <div class="form-group">
                  <label for="consumioCarne"
                    >4.22. ... carne roja (por ejemplo de vaca), carne de ave o
                    huevos?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioCarne"
                    id="consumioCarneSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioPescado"
                    >4.23. ... pescado fresco o enlatado?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioPescado"
                    id="consumioPescadoSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioAceites"
                    >4.24. ... aceites vegetales (como girasol, maíz, soja,
                    girasol alto oleico, oliva y canola)?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioAceites"
                    id="consumioAceitesSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioFrutasSecas"
                    >4.25. ... frutas secas sin salar (como maní, nueces,
                    almendras, avellanas, castañas, etc.) o semillas sin salar
                    (chía, girasol, sésamo, lino, etc.)?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioFrutasSecas"
                    id="consumioFrutasSecasSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioProductosCopetin"
                    >4.26. ... productos de copetín (papas fritas, palitos de
                    maíz, etc.)?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioProductosCopetin"
                    id="consumioProductosCopetinSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
                ...
                <div class="form-group">
                  <label for="consumioGolosinas"
                    >4.27. ... golosinas (caramelos, alfajores, chupetines,
                    chicles, barras de cereal, etc.)?</label
                  >
                  <select
                    class="form-control"
                    v-model="encuesta.consumioGolosinas"
                    id="consumioGolosinasSelect"
                  >
                    <option>Nunca o menos de 1 vez al mes</option>
                    <option>1 vez por semana</option>
                    <option>2 a 4 veces por semana</option>
