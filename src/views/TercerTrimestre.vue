          ...
          <form>
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    <label for="ultimaMenstruacion"
                      >Fecha de última menstruación</label
                    >
                    <input
                      type="date"
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="pliegueTricipital"
                      >3.5 Pliegue tricipital (cm)</label
                    >
                    <input
                      type="number"
                  ...
                  <div class="form-group col-md-6">
                    <label for="pliegueBicipital"
                      >3.6 Pliegue bicipital (cm)</label
                    >
                    <input
                      type="number"
