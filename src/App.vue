<template>
  <div id="app">
    <div id="nav">
      ...
      <router-link v-if="$auth.isAuthenticated" to="/primerYSegundoTrimestre"
        >| Primer y Segundo Trimestre
      </router-link>
      <router-link v-if="$auth.isAuthenticated" to="/tercerTrimestre"
        >| Tercer Trimestre
      </router-link>
      <router-link v-if="$auth.isAuthenticated" to="/neonato"
        >| Neonato
      </router-link>
      <router-link
        v-if="$auth.isAuthenticated && checkAdmin()"
        to="/profileAdmin"
